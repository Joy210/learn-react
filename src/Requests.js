...
const requests = {
  ...
  fetchCommedyMovies: `/discover/movie?api_key=${REACT_APP_TMDB_API_KEY}&with_genres=35`,
  fetchHorrorMovies: `/discover/movie?api_key=${REACT_APP_TMDB_API_KEY}&with_genres=27`,
  fetchRomanticMovies: `/discover/movie?api_key=${REACT_APP_TMDB_API_KEY}&with_genres=10749`,
  fetchDeocumentries: `/discover/movie?api_key=${REACT_APP_TMDB_API_KEY}&with_genres=99`,
};
